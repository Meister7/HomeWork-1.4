...
class ViewController: UIViewController {
    ...
    private lazy var titleLogin: UILabel = {
        ...
        private lazy var forgetpassword: UILabel = {
            ...
            let getster = UITapGestureRecognizer(target: self, action: #selector(clickForgotPassword))
        ...
        private lazy var signuplabel: UILabel = {
            ...
            let getster = UITapGestureRecognizer(target: self, action: #selector(clickSignUp))
    ...
    func validLogin(myLogin: String) -> Bool
      ...
      @objc func clickInfoLogin() {
          navigationController?.pushViewController(TermsOfUseController(), animated: true)
      }
